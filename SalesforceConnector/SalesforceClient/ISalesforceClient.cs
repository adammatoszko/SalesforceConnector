...
namespace SalesforceConnector.Client
{
    public interface ISalesforceClient
    {
        ...
        Task<T[]> QueryDataAsync<T>(string soql, CancellationToken token);
        ...
        ValueTask<List<DataModificationResultModel>> ModifyDataAsync<T>(T[] records, DataModificationType modificationType, bool allOrNone, CancellationToken token) where T : SalesforceObjectModel;
        ...
        /// <param name="token">Cancellation token.</param>
        /// <returns>Results of the modification.</returns>
        ValueTask<List<DataModificationResultModel>> ModifyDataAsync<T>(IEnumerable<T> records, DataModificationType modificationType, bool allOrNone, CancellationToken token) where T : SalesforceObjectModel;
    }
}